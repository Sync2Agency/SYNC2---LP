    ...
    <div className="fixed bottom-6 right-6 z-50">
      <AnimatePresence>
        {isOpen && (
          ...
          >
            <div className="p-5 bg-zinc-900 border-b border-zinc-800 flex justify-between items-center bg-gradient-to-r from-zinc-900 via-zinc-900 to-[#1a2d2e]">
              <div className="flex items-center gap-3">
                <div className="relative">
                  <div className="w-12 h-12 bg-[#8edce0] rounded-full flex items-center justify-center shadow-lg shadow-[#8edce0]/10">
                    <Zap className="text-[#373d43] w-7 h-7" />
                  </div>
